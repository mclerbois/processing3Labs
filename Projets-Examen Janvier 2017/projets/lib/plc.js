    ...
    process : function() {
        ...
        if (this.pulse) {
            var i=this.shiftRegister.length-1;
                ...
                this.shiftRegister[0]=this.data.v;
            }
...
var plcInputClass = Class.create({ 
    ...
    process : function() {
        this.state=this.negate ? (this.device.getState()==false) :  this.device.getState();
        },   
...
var plcClass = Class.create({ 
    ...
    initialize: function(ctx,location,actors) {
        ...
        this.running=false;
        this.inputs  = [null,null,null,null,null,null,null,null,null];
        this.outputs = [null,null,null,null,null,null,null,null,null];
        this.memos   = [null,null,null,null,null,null,null,null,null];
        this.difus   = [null,null,null,null,null,null,null,null,null];
        this.difds   = [null,null,null,null,null,null,null,null,null];
        this.timers  = [null,null,null,null,null,null,null,null,null];
        this.cnts    = [null,null,null,null,null,null,null,null,null];
        this.sfts    = [null,null,null,null,null,null,null,null,null];
        this.declare = {};
        this.program="";
    ...
    attachMemo : function(index,name) {
        this.memos[index]= new plcMemoClass();
        this.declare[name]={ alias : "MEMO"+index, props : ".v" };
        },
    ...
    attach : function(declarations) {
        for (var elem in declarations) {
            switch (declarations[elem].type){
                case "IN" :
                    declarations[elem].negate= (declarations[elem].negate==null) ? false : declarations[elem].negate;
                ...
                case "OUT" :
                    ...
                    break;
                case "MEMO" :
                    this.attachMemo( declarations[elem].index, elem);
                    break;
                case "DIFU" :
    ...
    setMemory : function() {
        ...
        this.memory["NO"] = { v : false};
        this.memory["YES"]= { v : true};
        this.memory["IL"] = { v : true};
        this.memory["ILC"]= { v : true};
        this.memory["CLK"]= this.clockState;
    ...
    process : function () {
        ...
        with (this.memory) {
            for (var i=0;i<this.program.length;i++) {
                if (this.program[i].search("ILC")!=-1)
                    this.memory["IL"]=true;
                if (this.memory["IL"])
                    eval(this.program[i]);
                else
                    eval(this.program[i]+"&& false");
                }
            }
